...
public class MessageComposer extends OdooActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CBind.setText((TextView) findViewById(R.id.recordName), getArgs().getString(KEY_RECORD_NAME));

        findViewById(R.id.btnCancel).setOnClickListener(this);
        findViewById(R.id.btnSend).setOnClickListener(this);
        CBind.setText((TextView) findViewById(R.id.messageSubject), "Re: " + getArgs().getString(KEY_RECORD_NAME));
        ...
        if (isNote) {
            ...
            CBind.setText((TextView) findViewById(R.id.btnSend), getString(R.string.label_log));
        }
